 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://service.message.security.webservices.cognoscenti.org/", wsdlLocation = "http://localhost:7777/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://service.message.security.webservices.cognoscenti.org/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://service.message.security.webservices.cognoscenti.org/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.message.security.webservices.cognoscenti.org/", "EchoPort"), Echo.class, features);
    }
